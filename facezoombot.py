...
class ZoomBot(telepot.Bot):
    ...
    def on_chat_message(self, msg):
        ...
        if content_type == 'text':
            ...
            headers = {'X-Mashape-Key': self.TOKEN_MA, 'Accept': 'application/json'}
            ...
            if len(faces['faces']) == 0 and chat_type == 'private':
                ...
                self.sendPhoto(chat_id, open(crop_path, 'rb'))
        else:
            if chat_type == 'private':
                self.sendMessage(chat_id, "I don't get it. Use /help to find out how this bot works.")
